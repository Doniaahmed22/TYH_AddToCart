        ...
        content += `
            <div class="row my-5 px-3 ">
                <div class="col-9 m-0 p-0">
                    <div class="m-0 p-0">
                        <p class="p-0 m-0 fs-4">${item.name}</p>
                        <p class="p-0 m-0 fs-6"><span>${item.size}</span> ${item.description}</p>
                    </div>
                </div>
                <div class="col-3">
                    <div class="row text-end">
                        <div class="col-4 fs-6 p-0">${item.quantity}x</div>
                        <div class="col-8 fs-6 p-0">${item.price} ${item.currency}</div>
                    </div>
                </div>
            </div>
        `;
